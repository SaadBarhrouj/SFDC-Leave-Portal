...
import getTeamRequestsHistory from '@salesforce/apex/TeamRequestsController.getTeamRequestsHistory';
...
const COLUMNS = [
    {
        ...
        type: 'avatarType',
        typeAttributes: {
            avatarUrl: { fieldName: 'RequesterFullPhotoUrl' },
...
export default class TeamRequestsHistory extends LightningElement {
    @track allRequests = [];
